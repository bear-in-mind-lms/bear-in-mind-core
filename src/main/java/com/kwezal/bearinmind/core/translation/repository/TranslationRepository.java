package com.kwezal.bearinmind.core.translation.repository;
...
public interface TranslationRepository extends JpaRepository<Translation, Long> {
    ...
    @Query(
        """
                    SELECT new com.kwezal.bearinmind.core.translation.dto.TranslationIdentifierAndTextDto(t.identifier, t.text)
                    FROM Translation t
    ...
    @Query(
        """
                    SELECT new com.kwezal.bearinmind.core.translation.dto.TranslationIdentifierAndTextDto(t1.identifier, COALESCE(t2.text, t1.text))
                    FROM Translation t1
                    LEFT JOIN Translation t2 ON (t2.identifier = t1.identifier AND t2.locale = :locale)
